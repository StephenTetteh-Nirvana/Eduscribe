...
const Footer = () => {
    return (
        <div className="relative w-full bg-[var(--primaryTheme)] text-white py-5 flex flex-col items-start px-10 min-h-[30vh]">

            {/* Title and Description  */}
            <div className="flex flex-col gap-2">
                <div className="flex gap-2">
                  <GraduationCap color="white" size={30}/>
                  <h1 className="text-[20px] md:text-[18px] lg:text-[20px] font-[900] text-center">EDUSCRIBE</h1>
                </div>
              <p 
                className="text-[14px] md:text-[16px] lg:text-[18px] font-[500]"
              >   
            ...
            <p className="w-full mt-5 text-center text-[12px] md:text-[14px] lg:text-[16px] font-[500]">© 2026 Eduscribe. All rights reserved.</p>
        </div>
    )
}
