      ...
      <div className="w-full flex flex-col items-center justify-center md:px-10 py-5">
        ...
        <div className="grid grid-cols-1 gap-5 mt-5 md:grid-cols-3 md:gap-5">
            {data.map((item, index) => (
                ...
                >
                  <h1 className="text-[var(--accentTheme)] text-center text-[20px] font-[700]">{item.plan}</h1>
                  <p className="text-center text-[25px] md:text-[30px] font-[600] text-[var(--primaryTheme)]">{item.price}</p>
